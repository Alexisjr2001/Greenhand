...
<head>
    ...
    <link href="PublishArticle.css" rel="stylesheet">
        ...
        <form action="HandleArticlePublish.php" class="form" method="post" enctype="multipart/form-data">
            ...
            <div id="category_container">
                ...
                <div id="category_checkbox">
                    <div>
                        <input type="checkbox" id="Sustainable_agriculture" name="categories[]"
                               value="Sustainable_agriculture">
                        <input type="hidden" id="Sustainable_agriculture" name="allCategories[]"
                               value="Sustainable_agriculture">
                    ...
                    <div>
                        ...
                        <input type="hidden" id="Marine_conservation" name="allCategories[]"
                               value="Marine_conservation">
                    ...
                    <div>
                        ...
                        <input type="hidden" id="Nature_conservation" name="allCategories[]"
            ...
            <div id="description_container">
                ...
                <textarea name="description" id="description" cols="30" rows="10"
                          placeholder="Give a brief description of your article"></textarea>
            </div>
            <div id="detailed_container">
                <label for="detailed" class="label">Detailed Article:</label>
                <textarea name="detailed" id="detailed" cols="30" rows="10"
                          placeholder="Compose your article's main body here"></textarea>
            </div>
            <div>
                <div id="multimedia_container">
                    <div class="label">Multimedia:</div>
                    <label for="multimedia" id="multimedia_button">Choose Files</label>
                    <input type="file" id="multimedia" multiple name="multimedia[]"
